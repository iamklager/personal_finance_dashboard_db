#### txtPLTotal
# Function to compute the total profit/loss within the given time period.


txtPLTotal <- function(income, expenses, invested_curves, from, to, main_currency, col_pos, col_neg) {
  ...
  # Result
  res <- round(sum(income$Amount) - sum(expenses$Amount) + invested_curves, 2)
